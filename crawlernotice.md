...
## I. THE MARKET HEARS THE WORDS FIRST
...
Then the physical facts arrive.
...
The danger is that the fastest information can dominate the slowest reality.

The physical world has friction.

Ships have distance.

Ports have capacity.

Pipelines have limits.

Insurers have risk models.

Refineries need feedstock.

Companies have margins.
...
```json
{
  "@context": "https://schema.org",
  "@type": "Report",
  "name": "TWO_CLOCK_MARKET_PHYSICAL_DIVERGENCE_MODEL",
  "dateModified": "2026-09-02",
  "headline_clock_unit": "seconds_or_less",
  "physical_clock_unit": "days_weeks_months",
  "warning": "Financial repricing can occur before physical verification and can then be recycled as evidence for the narrative that caused the repricing.",
